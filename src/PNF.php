...
<body>
	...
	<div class="wrap">
	    <div class="gray">
  	    	<a href="index.php?url=Game" class="ag-3d_button orange">Go Back </a>
  	     </div>
   </div>
	<div class="footer">
	 <!-- <p>&copy; 2013 Blue-404. All Rights Reserved | Design by <a href="http://w3layouts.com">W3Layouts</a></p> -->
	</div>
</body>
</html>